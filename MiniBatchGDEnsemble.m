function [W_enseble, b_enseble] = MiniBatchGDEnsemble(X, Y,y, XValid, YValid, yvalid, GDparams, W, b, plotTitle,plot_bool)
    rng(400);
    n_s = GDparams.n_s;
    W_enseble = cell(1, GDparams.nb_cycles);
    b_enseble = cell(1, GDparams.nb_cycles);
    Wstar=W;
    bstar=b;
    n = size(X,2);
    eval_per_cycle = 10;
