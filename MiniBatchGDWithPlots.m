function [Wstar, bstar] = MiniBatchGDWithPlots(X, Y,y, XValid, YValid, yvalid, GDparams, W, b, plotTitle)
    rng(400);
    n_s = GDparams.n_s;
    Wstar=W;
    bstar=b;
    ...
    for l=0:GDparams.nb_cycles-1
        while t<(2*l+1)*n_s
            ...
            [Wstar,bstar,batch_offset,X,Y,plot_info,eval_step,t] = update(eta,n,X,Y,y,XValid, YValid,yvalid,Wstar,bstar,GDparams,nb_layers,batch_offset,t,eval_interval,eval_step,plot_info);
        end
        while t<2*(l+1)*n_s
