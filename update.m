function [Wstar,bstar,j,X,Y,plot_info,eval_step,t] = update(eta,n,X,Y,y,XValid, YValid,yvalid,Wstar,bstar,GDparams,nb_layers,j,t,eval_interval,eval_step,plot_info,plot)
